 ...
 * @author Korisnik
 */
public class AzurirajPodtipRadovaForma extends javax.swing.JDialog {
     ...
     */
    public AzurirajPodtipRadovaForma(java.awt.Dialog parent, PodtipRadova pr1, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        pod.setUkupnaCena(pr.getUkupnaCena());
        boolean uspesno = Kontroler.getInstanca().updatePodtipRadova(pod);
        if (uspesno) {
            ...
            JOptionPane.showMessageDialog(this, "Greska pri izmeni Podtipa radova");
        }
