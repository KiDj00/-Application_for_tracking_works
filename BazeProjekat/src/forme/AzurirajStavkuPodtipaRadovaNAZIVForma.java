 ...
 * @author Korisnik
 */
public class AzurirajStavkuPodtipaRadovaNAZIVForma extends javax.swing.JDialog {

    private final StavkaPodtipaRadova stavka;

    /**
     * Creates new form DodajRadnikaForma
     */
    public AzurirajStavkuPodtipaRadovaNAZIVForma(java.awt.Dialog parent, StavkaPodtipaRadova spr, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        //  popuniJediniceMere();
        stavka = spr;
        txttip.setText("" + stavka.getPodtipRadova().getTipradovaId().getId());
        txtpod.setText("" + stavka.getPodtipRadova().getPodtipRadovaId());
        txtNaziv.setText(stavka.getNazivRada());
        txtcena.setText("" + stavka.getJedinicnaCena());
        txtopis.setText(stavka.getOpisRadova());
        txtstavka.setText("" + stavka.getStavkaId());
        txtKolicina.setText("" + stavka.getKolicina());
        txtJM.setText(stavka.getNazivJediniceMere());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtJM.getText().isEmpty() || txtKolicina.getText().isEmpty() || txtNaziv.getText().isEmpty() || txtcena.getText().isEmpty() || txtopis.getText().isEmpty()
        ...
        //  spr.setNazivJediniceMere(jm);
        spr.setNazivRada(txtNaziv.getText());
        ...
        ptr.setTipradovaId(stavka.getPodtipRadova().getTipradovaId());
        ptr.setPodtipRadovaId(stavka.getPodtipRadova().getPodtipRadovaId());
