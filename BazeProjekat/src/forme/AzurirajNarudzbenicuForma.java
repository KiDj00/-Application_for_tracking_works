 ...
 * @author Korisnik
 */
public class AzurirajNarudzbenicuForma extends javax.swing.JDialog {

    private final Narudzbenica nGlobal;

    /**
     * Creates new form DodajNarudzbenicuForma
     */
    public AzurirajNarudzbenicuForma(java.awt.Dialog parent, Narudzbenica nar, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        popuniKompanije();
        nGlobal = nar;
        txtid.setText("" + nGlobal.getId());
        txtcena.setText("" + nGlobal.getCena().getVrednost());
        txtpdv.setText("" + nGlobal.getCena().getPdv());
        txtMesto.setText("" + nGlobal.getPostanskiBroj().getPostanskiBroj());
        txtNacelnik.setText("" + nGlobal.getNacelnikId().getId());
        txtNacin.setText(nGlobal.getNacinPlacanja());
        txtZapisnik.setText("" + nGlobal.getZapisnikId().getId());
    ...
    private void initComponents() {
        ...
        lblLegalEntityText1.setText("NARUDŽBENICU");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jdcGarantni.getDate() == null || jdcrok.getDate() == null) {
