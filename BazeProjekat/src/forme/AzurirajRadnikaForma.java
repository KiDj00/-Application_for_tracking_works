 ...
 * @author Korisnik
 */
public class AzurirajRadnikaForma extends javax.swing.JDialog {

    /**
     * Creates new form DodajRadnikaForma
     */
    public AzurirajRadnikaForma(Dialog parent, Radnik r, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        txtzvanje.setText(radnik.getZvanje());
        txttel.setText(radnik.getTelefon());
    }
