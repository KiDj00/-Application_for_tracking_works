 ...
 * @author Korisnik
 */
public class DodajPodtipRadovaForma extends javax.swing.JDialog {

    /**
     * Creates new form DodajRadnikaForma
     */
    public DodajPodtipRadovaForma(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblLegalEntityText1.setText("PODTIPA RADOVA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PodtipRadova pr = new PodtipRadova();
        TipRadova tp = new TipRadova(Integer.parseInt(txttip.getText()), null, null);
        pr.setTipradovaId(tp);
        pr.setPodtipRadovaId(Integer.parseInt(txtpod.getText()));
        pr.setNaziv(txtnaziv.getText());
        boolean uspesno = Kontroler.getInstanca().insertPodtipRadova(pr);
        if (uspesno) {
            JOptionPane.showMessageDialog(this, "Uspešno ste dodali Podtip radova");
            PredmerRadovaForma prf = (PredmerRadovaForma) this.getParent();
            prf.prikaziPodtipRadova(tp);
            this.setVisible(false);
        } else {
            JOptionPane.showMessageDialog(this, "Greška pri dodavanju Podtipa radova");
        }
